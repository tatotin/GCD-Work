...
setwd("~/Dropbox/box documents/coursera/Reproducible research/")
if (!"StormData.csv.bz2" %in% dir("./data/")) {
  print("Downloading from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip")
  download.file("https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip", destfile = "data/getdata-projectfiles-UCI HAR Dataset.zip")
  unzip("data/getdata-projectfiles-UCI HAR Dataset.zip", overwrite=T, remove=F)
}

# Second, use source("run_analysis.R") command in RStudio. THIS IS THE FILE!!
